			...
			<div className='grid gap-10 lg:grid-cols-2'>
				<div className='flex flex-col justify-center md:pr-8 xl:pr-0 lg:max-w-lg'>
					...
					<div className='max-w-xl mb-6'>
						<h2 className='max-w-lg mb-6 font-sans text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl sm:leading-none'>
							...
							your next EVENT: <span className='inline-block text-secondary'>{selector[0]?.name}.</span>
						</h2>
						<p className='text-base text-gray-700 md:text-lg'>
							Here in Klendar©, our first priority is to satisfy our users. We value your events and understand the importance of providing accurate and meaningful reason to add it. Your event, "
							{selector[0]?.name}" which has a description:
							{selector[0]?.description} , provides an integral part of our commitment to delivering a personalized and user-centric experience.
						</p>
					</div>
				...
				<div className='flex items-center justify-center -mx-4 lg:pl-8'>
					<div className='flex flex-col items-end px-3'>
						<img className='object-cover mb-6 rounded shadow-lg h-28 sm:h-56 xl:h-80 w-28 sm:w-48 xl:w-80' src={img2} alt='' />
						<img className='object-cover w-20 h-20 rounded shadow-lg sm:h-44  xl:h-56 sm:w-40 xl:w-56' src={img} alt='' />
					</div>
					<div className='px-3'>
						<img
						...
						<div className='px-3 py-5'>
							<img className='object-cover w-20 h-20 rounded shadow-lg sm:h-44  xl:h-56 sm:w-40 xl:w-56' src={selector[0]?.image} alt='You have not provided an image.' />
						</div>
					</div>
				</div>
			</div>
