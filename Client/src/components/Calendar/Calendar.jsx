						...
						<div className='drawer drawer-end'>
							...
							<div className='drawer-side'>
								...
								<ul className='menu p-4 w-[40vw] h-full from-[#076585]  to-[#fff] bg-gradient-to-b text-base-content'>
									<form>
										<h1 className=' font-[Poppins] text-4xl drop-shadow-lg shadow-black mb-10 text-white  mt-5 '>Add your custom event.</h1>
										<div className='grid  gap-6 mb-6 md:grid-cols-2'>
											<div>
												<label for='first_name' className='block mb-2 text-sm font-medium font-[Poppins] text-white dark:text-white'>
													Name
												</label>
												<input
													type='text'
											...
											<div>
												<label for='last_name' className='block mb-2 text-sm font-medium font-[Poppins] text-white dark:text-white'>
													Initial Date
												</label>
												<input
													type='date'
											...
											<div>
												<label for='company' className='block mb-2 text-sm font-[Poppins] font-medium text-white dark:text-white'>
													Final Date
												</label>
												<input
													type='date'
											...
											<div>
												<label for='phone' className='block mb-2 text-sm font-[Poppins] font-medium text-white dark:text-white'>
													Image
												</label>
												<input
													type='tel'
											...
											<div>
												<label for='website' className='block mb-2  font-[Poppins] text-sm font-medium text-white dark:text-white'>
													Description
												</label>
												<input
													type='url'
											...
											<div>
												<label for='visitors' className='block mb-2 text-sm font-[Poppins] font-medium text-white dark:text-white'>
													Location
												</label>
												<input
													type='number'
										...
										<div className=' mb-6'>
											<label for='email' className='block mb-2 text-sm font-[Poppins] font-medium text-white dark:text-white'>
												Category
											</label>
											<input
												type='email'
										...
										<div className='flex items-start mb-6'>
											...
											<label for='remember' className='ml-2 text-sm font-medium font-[Poppins] text-gray-900 dark:text-gray-300'>
												Remind me of my {""}
												<a href='#' className='text-blue-600 font-[Poppins] hover:underline dark:text-blue-500'>
													new event.
												</a>
												.
											</label>
						...
						<tr className='text-center h-20'>
							{month.slice(0, 7).map((day) => {
								if (Number(day.fullDate.split("-")[1]) === monthNumber + 1) {
									...
									return (
										<td key={day.date} className='border bg-gray-100 p-1 h-20 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300'>
											<div className='flex flex-col h-36  xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden'>
						...
						<tr className='text-center h-20'>
							{month.slice(7, 14).map((day) => {
								if (Number(day.fullDate.split("-")[1]) === monthNumber + 1) {
									...
									return (
										<td key={day.date} className='border bg-gray-100 p-1 h-36 xl:w-40 lg:w-30 md:w-30 sm:w-20 w-10 overflow-auto transition cursor-pointer duration-500 ease hover:bg-gray-300'>
											<div className='flex flex-col h-36  xl:w-40 lg:w-30 md:w-30 sm:w-full w-10 mx-auto overflow-hidden'>
												<div className='top h-5 w-full'>
													<div className={today === day.fullDate ? "mx-auto w-6 h-6 rounded-full bg-blue-600" : "text-gray-500"}>{day.date}</div>
												</div>
