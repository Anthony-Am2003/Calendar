			...
			<div className='min-w-[50%] max-w-lg border rounded-lg bg-[#fff9]'>
				...
				<form action='' className='mb-0 mt-3 space-y-4 rounded-lg p-4 shadow-lg sm:p-6 lg:p-8' onSubmit={handleSumbit}>
					...
					!errors.passwordLetter ? (
						...
						<button type='submit' className='block w-full rounded-lg bg-indigo-600 px-5 py-3 text-sm font-medium text-white disabled:opacity-30 font-[Poppins]' disabled>
							Sign up
						</button>
					)}
					{errors &&
					(errors.username ||
						...
						errors.passwordMatch ||
						errors.passwordLetter) ? (
						<h1 className='text-sm text-gray-420 font-[Poppins]'>Check your errors</h1>
					) : (
						<h1></h1>
					)}
